    ...
    jQuery(document)
        ...
        .on('click.filesActions', '[data-file-action]', function (event) {
            ...
            switch (action) {
                ...
                case 'preview-image':
                    event.preventDefault();
                    Databank.files.previewUI.previewImage($target.data('iiif-root'), $target.data('web-id'));
                    break;
                case 'remove-row':
                    event.preventDefault();
                ...
                case 'remove-filejob':
                    event.preventDefault();
                    Databank.files.rowMutations.removeFileJobRow($target.data('job-id'), $target.data('datafile-id'));
                    break;
        ...
        .on('change.filesActions', '[data-file-action="selection-change"]', function () {
